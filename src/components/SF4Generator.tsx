          ...
          <form id="sf4-form" onSubmit={handleGenerateClick} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
               <div>
                 ...
                 <input required type="text" name="designation" list="sf4-emp-designations" value={formData.designation} onChange={handleChange} className="w-full text-sm border-gray-300 rounded px-2.5 py-1.5 focus:ring-indigo-500 focus:border-indigo-500 border bg-gray-50 focus:bg-white" placeholder="e.g. CS&WI/P/NJP" />
                  <datalist id="sf4-emp-designations">
